...
BASE_URL = f'https://bestbuy.ca/ecomm-api/availability/products?accept=application%2Fvnd.bestbuy.standardproduct.v1%2Bjson&accept-language=en-CA&skus={PS5_PRODUCT_ID}'
...
class BestBuy(Store):
    def check(self) -> bool:
        ...
        try:
            ...
            json_response = raw_response.replace('\ufeff', '').replace('\r\n', '')
        ...
        for availability in availabilities:
            ...
            if purchasable:
                ...
                loop.run_until_complete(
                    self.stock_alert(provider='Bestbuy', link=f'https://www.bestbuy.ca/en-ca/product/{PS5_PRODUCT_ID}')
                )
